...
const names$1 = {
  ...
  data: new codegen_1$R.Name("data"),
  // data passed to validation function
  // args passed from referencing schema
  valCxt: new codegen_1$R.Name("valCxt"),
  // validation/data context - should not be used directly, it is destructured to the names below
  instancePath: new codegen_1$R.Name("instancePath"),
  parentData: new codegen_1$R.Name("parentData"),
  parentDataProperty: new codegen_1$R.Name("parentDataProperty"),
  rootData: new codegen_1$R.Name("rootData"),
  // root data - same as the data passed to the first/top validation function
  dynamicAnchors: new codegen_1$R.Name("dynamicAnchors"),
  // used to support recursiveRef and dynamicRef
  // function scoped variables
  vErrors: new codegen_1$R.Name("vErrors"),
  // null or array of validation errors
  errors: new codegen_1$R.Name("errors"),
  // counter of validation errors
  this: new codegen_1$R.Name("this"),
  // "globals"
  self: new codegen_1$R.Name("self"),
  scope: new codegen_1$R.Name("scope"),
  // JTD serialize/parse name for JSON string and position
  json: new codegen_1$R.Name("json"),
  jsonPos: new codegen_1$R.Name("jsonPos"),
  jsonLen: new codegen_1$R.Name("jsonLen"),
  jsonPart: new codegen_1$R.Name("jsonPart")
};
